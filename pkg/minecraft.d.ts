...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hfc6d45c2317fc54a: (a: number, b: number) => void;
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h98144601ed6fd0e2: (a: number, b: number) => void;
  readonly closure176_externref_shim: (a: number, b: number, c: any) => void;
